...
```{r, fig.align='center', fig.cap="Figure 1. Visual Representation of IIDs" ,echo=FALSE, dpi = 800}
knitr::include_graphics("images/iconsIID_smaller.png")
#![Visual representation of IID](images/iconsIID_smaller.png)
```
...
their ratio, in distinct ways (Figure 2).

```{r fig.align='center', fig.cap="Figure 2. Simulations of CV metrics under three range shift scenarios", echo=FALSE, dpi = 800}
knitr::include_graphics("images/simsfig.png")
```
